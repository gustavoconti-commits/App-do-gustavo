-- =============================================================
-- Casal em Forma — INSTALAÇÃO COMPLETA DO BANCO (colar uma vez)
--
-- Como usar: no painel do Supabase, abra "SQL Editor" →
-- "New query", cole este arquivo INTEIRO e clique em "Run".
-- Ele cria todas as tabelas, as regras de segurança e os dois
-- perfis (Gustavo e Júlia). Rodar uma única vez.
-- =============================================================
